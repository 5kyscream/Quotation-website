...
export const generatePptx = async (formData) => {
  ...
  if (formData.showBenefitsPage !== false) {
  ...
  if (formData.showSystemPricingPage !== false) {
  ...
  if (formData.showProjectOutcomesPage !== false) {
  ...
  if (formData.showScopePage !== false) {
  ...
  if (formData.showBomPage !== false) {
    ...
    formData.bomItems.filter(item => item.enabled !== false).forEach(item => {
  ...
  if (formData.showContactPage !== false) {
